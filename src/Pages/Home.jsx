...
const WORDS = [" Electronics&Communication Engineering", "Tech Enthusiast"];
const TECH_STACK = ["VLSI", "Embedded systems", "IOT", "WEB DEV"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/harsha0p6300" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/behara-harshavardhan-67683125b/" },
  { icon: Instagram, link: "https://www.instagram.com/im_harsha_96/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Tech isn't just tools — it's how we shape tomorrow                </p>
